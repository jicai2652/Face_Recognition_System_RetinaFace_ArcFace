...
class IResNet(nn.Module):
    ...
    def __init__(self, block, layers, dropout_keep_prob=0, embedding_size=512, zero_init_residual=False,groups=1, width_per_group=64, replace_stride_with_dilation=None, fp16=False):
